...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.message.photo:  # Fotoğraf geldiyse
        await update.message.reply_text("📸 Güzel fotoğraf! Ne hakkında konuşmak istiyorsun? Anlat bakalım.")
    else:  # Normal metin mesajı
...
if __name__ == "__main__":
    ...
    print("✅ Bot Render'da çalışıyor... (Fotoğraf desteği aktif)")
    app.run_polling()
